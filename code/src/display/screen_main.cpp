...
static void _drawEmergencyScreen(U8G2& display) {
    static const unsigned char image_Restoring_icon_bits[] PROGMEM = {};
    ...
    // Static frame
    display.drawFrame(0, 0, 128, 2);
    display.drawFrame(0, 62, 128, 2);
    display.drawFrame(0, 2, 128, 60);

    // Static text
    display.setFont(u8g2_font_profont22_tr);
    display.drawStr(8, 39, "S.V.P");
    display.setFont(u8g2_font_profont17_tr);
    display.drawStr(8, 55, "Reset bouton");

    // Icon blinks
    bool blinkOn = ((millis() / BLINK_INTERVAL_MS) % 2) == 0;
    if (blinkOn) {
        display.drawXBMP(84, 6, 38, 32, image_Restoring_icon_bits);
    }
